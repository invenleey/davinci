...
public class SqlUtils {
    ...
    public PaginateWithQueryColumns query4Paginate(String sql, int pageNo, int pageSize, int totalCount, int limit, Set<String> excludeColumns) throws Exception {
        ...
        if (pageNo < 1 && pageSize < 1) {
        	// TODO r3inbowari debug
			// FTQQDebugConnector.DebugMsg("queryMsg", sql + "here1");
            if (limit > 0) {
			...
			// FTQQDebugConnector.DebugMsg("queryMsg", sql + "here2");
    ...
    private void getResultForPaginate(String sql, PaginateWithQueryColumns paginateWithQueryColumns, JdbcTemplate jdbcTemplate, Set<String> excludeColumns, int startRow) {
		...
		jdbcTemplate.query(sql, rs -> {
			...
			// FTQQDebugConnector.DebugMsg("getResultForPaginate", String.valueOf(metaData.getColumnCount()) +getColumnLabel(queryFromsAndJoins, metaData.getColumnLabel(1)) + "@" + getColumnLabel(queryFromsAndJoins, metaData.getColumnTypeName(1) ));
